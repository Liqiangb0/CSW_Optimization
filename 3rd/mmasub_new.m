...
mmasub_new(m,n,iter,xval,xmin,xmax,xold1,xold2, ...
f0val,df0dx,fval,dfdx,low,upp,a0,a,c,d,beta,restartAs)
%
...
if (iter < 2.5 || restartAs == 1)
  low = xval - asyinit*(xmax-xmin)./(1+beta);
  upp = xval + asyinit*(xmax-xmin)./(1+beta);
else
